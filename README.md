...
This folder includes the tools used to analize the data that were measured using the instruments previously mentioned. Visualizing data and fitting into typical quantum optics functions like g2, lifetime exponentials or saturation curves are some of the main characters inside this folder.

## ⚙️ Measure Automation
...
# 📄 Papers from this experiments.

This experimental setup has lead to many publications and posters. See
